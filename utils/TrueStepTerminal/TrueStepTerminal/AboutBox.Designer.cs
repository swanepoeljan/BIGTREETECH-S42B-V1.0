...
namespace TrueStepTerminal
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.tableLayoutPanel.Controls.Add(this.labelBuild, 1, 4);
			...
			this.labelBuild.Location = new System.Drawing.Point(140, 104);
			this.labelBuild.Name = "labelBuild";
			this.labelBuild.Size = new System.Drawing.Size(274, 26);
			this.labelBuild.TabIndex = 25;
			this.labelBuild.Text = "Build date";
			// 
			// AboutBox
			// 
